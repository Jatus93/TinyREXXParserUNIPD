...
public:
  ...
  virtual void enterI_op(tinyrexxParser::I_opContext *ctx) = 0;
  virtual void exitI_op(tinyrexxParser::I_opContext *ctx) = 0;
  ...
  virtual void enterL_else(tinyrexxParser::L_elseContext *ctx) = 0;
  virtual void exitL_else(tinyrexxParser::L_elseContext *ctx) = 0;

  virtual void enterIf_proxy(tinyrexxParser::If_proxyContext *ctx) = 0;
  virtual void exitIf_proxy(tinyrexxParser::If_proxyContext *ctx) = 0;

  virtual void enterFor_proxy(tinyrexxParser::For_proxyContext *ctx) = 0;
  virtual void exitFor_proxy(tinyrexxParser::For_proxyContext *ctx) = 0;

  virtual void enterTo_r(tinyrexxParser::To_rContext *ctx) = 0;
  virtual void exitTo_r(tinyrexxParser::To_rContext *ctx) = 0;
  ...
  virtual void enterBool_OP(tinyrexxParser::Bool_OPContext *ctx) = 0;
  virtual void exitBool_OP(tinyrexxParser::Bool_OPContext *ctx) = 0;

  virtual void enterB_op(tinyrexxParser::B_opContext *ctx) = 0;
  virtual void exitB_op(tinyrexxParser::B_opContext *ctx) = 0;

  virtual void enterB_not(tinyrexxParser::B_notContext *ctx) = 0;
  virtual void exitB_not(tinyrexxParser::B_notContext *ctx) = 0;
