...
tinyrexxParser::I_opContext* tinyrexxParser::StatementContext::i_op() {
  return getRuleContext<tinyrexxParser::I_opContext>(0);
}
...
tinyrexxParser::I_opContext::I_opContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tinyrexxParser::If_proxyContext* tinyrexxParser::I_opContext::if_proxy() {
  return getRuleContext<tinyrexxParser::If_proxyContext>(0);
}

std::vector<tinyrexxParser::StatementContext *> tinyrexxParser::I_opContext::statement() {
  return getRuleContexts<tinyrexxParser::StatementContext>();
}

tinyrexxParser::StatementContext* tinyrexxParser::I_opContext::statement(size_t i) {
  return getRuleContext<tinyrexxParser::StatementContext>(i);
}

tinyrexxParser::L_elseContext* tinyrexxParser::I_opContext::l_else() {
  return getRuleContext<tinyrexxParser::L_elseContext>(0);
}


size_t tinyrexxParser::I_opContext::getRuleIndex() const {
  return tinyrexxParser::RuleI_op;
}

void tinyrexxParser::I_opContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterI_op(this);
}

void tinyrexxParser::I_opContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitI_op(this);
}

tinyrexxParser::I_opContext* tinyrexxParser::i_op() {
  I_opContext *_localctx = _tracker.createInstance<I_opContext>(_ctx, getState());
  enterRule(_localctx, 10, tinyrexxParser::RuleI_op);
  size_t _la = 0;
...
tinyrexxParser::If_proxyContext* tinyrexxParser::W_loopContext::if_proxy() {
  return getRuleContext<tinyrexxParser::If_proxyContext>(0);
}
...
tinyrexxParser::For_proxyContext* tinyrexxParser::F_loopContext::for_proxy() {
  return getRuleContext<tinyrexxParser::For_proxyContext>(0);
}
...
tinyrexxParser::L_elseContext::L_elseContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}


size_t tinyrexxParser::L_elseContext::getRuleIndex() const {
  return tinyrexxParser::RuleL_else;
}

void tinyrexxParser::L_elseContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterL_else(this);
}

void tinyrexxParser::L_elseContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitL_else(this);
}

tinyrexxParser::L_elseContext* tinyrexxParser::l_else() {
  L_elseContext *_localctx = _tracker.createInstance<L_elseContext>(_ctx, getState());
  enterRule(_localctx, 16, tinyrexxParser::RuleL_else);
...
tinyrexxParser::If_proxyContext::If_proxyContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tinyrexxParser::Bool_OPContext* tinyrexxParser::If_proxyContext::bool_OP() {
  return getRuleContext<tinyrexxParser::Bool_OPContext>(0);
}


size_t tinyrexxParser::If_proxyContext::getRuleIndex() const {
  return tinyrexxParser::RuleIf_proxy;
}

void tinyrexxParser::If_proxyContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterIf_proxy(this);
}

void tinyrexxParser::If_proxyContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitIf_proxy(this);
}

tinyrexxParser::If_proxyContext* tinyrexxParser::if_proxy() {
  If_proxyContext *_localctx = _tracker.createInstance<If_proxyContext>(_ctx, getState());
  enterRule(_localctx, 18, tinyrexxParser::RuleIf_proxy);
...
tinyrexxParser::For_proxyContext::For_proxyContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* tinyrexxParser::For_proxyContext::ID() {
  return getToken(tinyrexxParser::ID, 0);
}

std::vector<tinyrexxParser::A_exprContext *> tinyrexxParser::For_proxyContext::a_expr() {
  return getRuleContexts<tinyrexxParser::A_exprContext>();
}

tinyrexxParser::A_exprContext* tinyrexxParser::For_proxyContext::a_expr(size_t i) {
  return getRuleContext<tinyrexxParser::A_exprContext>(i);
}

tinyrexxParser::To_rContext* tinyrexxParser::For_proxyContext::to_r() {
  return getRuleContext<tinyrexxParser::To_rContext>(0);
}


size_t tinyrexxParser::For_proxyContext::getRuleIndex() const {
  return tinyrexxParser::RuleFor_proxy;
}

void tinyrexxParser::For_proxyContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterFor_proxy(this);
}

void tinyrexxParser::For_proxyContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitFor_proxy(this);
}

tinyrexxParser::For_proxyContext* tinyrexxParser::for_proxy() {
  For_proxyContext *_localctx = _tracker.createInstance<For_proxyContext>(_ctx, getState());
  enterRule(_localctx, 20, tinyrexxParser::RuleFor_proxy);
...
tinyrexxParser::To_rContext::To_rContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}


size_t tinyrexxParser::To_rContext::getRuleIndex() const {
  return tinyrexxParser::RuleTo_r;
}

void tinyrexxParser::To_rContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterTo_r(this);
}

void tinyrexxParser::To_rContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitTo_r(this);
}

tinyrexxParser::To_rContext* tinyrexxParser::to_r() {
  To_rContext *_localctx = _tracker.createInstance<To_rContext>(_ctx, getState());
  enterRule(_localctx, 22, tinyrexxParser::RuleTo_r);
...
tinyrexxParser::Bool_OPContext::Bool_OPContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* tinyrexxParser::Bool_OPContext::OPENP() {
  return getToken(tinyrexxParser::OPENP, 0);
}

std::vector<tinyrexxParser::Bool_OPContext *> tinyrexxParser::Bool_OPContext::bool_OP() {
  return getRuleContexts<tinyrexxParser::Bool_OPContext>();
}

tinyrexxParser::Bool_OPContext* tinyrexxParser::Bool_OPContext::bool_OP(size_t i) {
  return getRuleContext<tinyrexxParser::Bool_OPContext>(i);
}

tree::TerminalNode* tinyrexxParser::Bool_OPContext::CLOSEP() {
  return getToken(tinyrexxParser::CLOSEP, 0);
}

tinyrexxParser::B_notContext* tinyrexxParser::Bool_OPContext::b_not() {
  return getRuleContext<tinyrexxParser::B_notContext>(0);
}

std::vector<tinyrexxParser::A_exprContext *> tinyrexxParser::Bool_OPContext::a_expr() {
  return getRuleContexts<tinyrexxParser::A_exprContext>();
}

tinyrexxParser::A_exprContext* tinyrexxParser::Bool_OPContext::a_expr(size_t i) {
  return getRuleContext<tinyrexxParser::A_exprContext>(i);
}

tinyrexxParser::R_opContext* tinyrexxParser::Bool_OPContext::r_op() {
  return getRuleContext<tinyrexxParser::R_opContext>(0);
}

tinyrexxParser::B_opContext* tinyrexxParser::Bool_OPContext::b_op() {
  return getRuleContext<tinyrexxParser::B_opContext>(0);
}


size_t tinyrexxParser::Bool_OPContext::getRuleIndex() const {
  return tinyrexxParser::RuleBool_OP;
}

void tinyrexxParser::Bool_OPContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterBool_OP(this);
}

void tinyrexxParser::Bool_OPContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
...
tinyrexxParser::Bool_OPContext* tinyrexxParser::bool_OP() {
   return bool_OP(0);
}

tinyrexxParser::Bool_OPContext* tinyrexxParser::bool_OP(int precedence) {
  ParserRuleContext *parentContext = _ctx;
  size_t parentState = getState();
  tinyrexxParser::Bool_OPContext *_localctx = _tracker.createInstance<Bool_OPContext>(_ctx, parentState);
  tinyrexxParser::Bool_OPContext *previousContext = _localctx;
  size_t startState = 32;
  enterRecursionRule(_localctx, 32, tinyrexxParser::RuleBool_OP, precedence);
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        if (!_parseListeners.empty())
          triggerExitRuleEvent();
        previousContext = _localctx;
        _localctx = _tracker.createInstance<Bool_OPContext>(parentContext, parentState);
        pushNewRecursionContext(_localctx, startState, RuleBool_OP);
        setState(167);
...
tinyrexxParser::B_opContext* tinyrexxParser::b_op() {
  ...
  enterRule(_localctx, 34, tinyrexxParser::RuleB_op);
  size_t _la = 0;
...
tinyrexxParser::B_notContext::B_notContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* tinyrexxParser::B_notContext::NOT() {
  return getToken(tinyrexxParser::NOT, 0);
}


size_t tinyrexxParser::B_notContext::getRuleIndex() const {
  return tinyrexxParser::RuleB_not;
}

void tinyrexxParser::B_notContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterB_not(this);
}

void tinyrexxParser::B_notContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<tinyrexxListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitB_not(this);
}

tinyrexxParser::B_notContext* tinyrexxParser::b_not() {
  B_notContext *_localctx = _tracker.createInstance<B_notContext>(_ctx, getState());
  enterRule(_localctx, 36, tinyrexxParser::RuleB_not);
...
bool tinyrexxParser::sempred(RuleContext *context, size_t ruleIndex, size_t predicateIndex) {
  switch (ruleIndex) {
    ...
    case 16: return bool_OPSempred(dynamic_cast<Bool_OPContext *>(context), predicateIndex);
...
bool tinyrexxParser::bool_OPSempred(Bool_OPContext *_localctx, size_t predicateIndex) {
  switch (predicateIndex) {
...
std::vector<std::string> tinyrexxParser::_ruleNames = {
  "program", "statement", "assign", "print", "input", "i_op", "w_loop", 
  "f_loop", "l_else", "if_proxy", "for_proxy", "to_r", "a_expr", "a_op", 
  "r_op", "terminate", "bool_OP", "b_op", "b_not"
};

std::vector<std::string> tinyrexxParser::_literalNames = {
  "", "'='", "'say'", "'pull'", "'if'", "'then'", "'do'", "'end'", "'while'", 
  "'else'", "'to'", "'exit'", "'('", "')'", "'-'", "'+'", "'*'", "'/'", 
  "'=='", "'<'", "'<='", "'>'", "'>='", "'&'", "'|'", "'\\'"
};
...
std::vector<std::string> tinyrexxParser::_symbolicNames = {
  "", "", "", "", "", "", "", "", "", "", "", "", "OPENP", "CLOSEP", "MINUS", 
  "PLUS", "MUL", "DIV", "EQUAL", "LT", "LEQ", "GT", "GEQ", "AND", "OR", 
  "NOT", "ID", "NUMBER", "WS", "ErrorChar"
};
...
tinyrexxParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x1f, 0xb7, 0x4, 0x2, 0x9, 0x2, 0x4, 0x3, 0x9, 0x3, 0x4, 0x4, 0x9, 
    ...
    0x51, 0xa, 0x7, 0xd, 0x7, 0xe, 0x7, 0x52, 0x3, 0x7, 0x3, 0x7, 0x3, 0x7, 
    0x3, 0x7, 0x6, 0x7, 0x59, 0xa, 0x7, 0xd, 0x7, 0xe, 0x7, 0x5a, 0x3, 0x7, 
    0x3, 0x7, 0x5, 0x7, 0x5f, 0xa, 0x7, 0x3, 0x8, 0x3, 0x8, 0x3, 0x8, 0x3, 
    0x8, 0x6, 0x8, 0x65, 0xa, 0x8, 0xd, 0x8, 0xe, 0x8, 0x66, 0x3, 0x8, 0x3, 
    0x8, 0x3, 0x9, 0x3, 0x9, 0x3, 0x9, 0x6, 0x9, 0x6e, 0xa, 0x9, 0xd, 0x9, 
    0xe, 0x9, 0x6f, 0x3, 0x9, 0x3, 0x9, 0x3, 0xa, 0x3, 0xa, 0x3, 0xb, 0x3, 
    0xb, 0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x3, 
    0xd, 0x3, 0xd, 0x3, 0xe, 0x3, 0xe, 0x3, 0xe, 0x3, 0xe, 0x3, 0xe, 0x3, 
    0xe, 0x3, 0xe, 0x3, 0xe, 0x3, 0xe, 0x5, 0xe, 0x89, 0xa, 0xe, 0x3, 0xe, 
    0x3, 0xe, 0x3, 0xe, 0x3, 0xe, 0